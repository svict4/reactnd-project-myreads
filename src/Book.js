    ...
    render() {
        return (
            ...
            {this.props.bookshelves.map(shelf => (
                <option value="{shelf.key}" {...this.props.selected === shelf.key ? 'disabled' : ''}>{shelf.title}</option>
            ))}        
            </select>
        )
    }
                ...
                <div className="book">
                    ...
                    <div className="book-cover" style={{ width: 128, height: 193, backgroundImage: 'url("{book.imageLinks.thumbnail}")' }}></div>
                        <div className="book-shelf-changer">
                            <ShelfChanger selected="{book.shelf}" bookshelves="{this.props.bookshelves}"></ShelfChanger>
                        </div>
                    </div>
